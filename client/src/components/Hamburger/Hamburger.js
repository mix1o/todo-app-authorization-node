      ...
      <HelpDiv isOpen={isOpen}>
        ...
        <HamburgerDiv>
          ...
          <div style={{textAlign: 'center',marginTop: '5rem'}}>
              <p style={{fontSize: '3rem',color: '#fff'}}><span style={{color: "#2d3748",fontWeight: '700'}}>mn</span>Tasks</p>
          </div>
          <div className="info__user">
            <p className="first">Hello!</p>
            {state.correct && (
              <p className="second">{state.userData.user[0].name} {state.userData.user[0].surrname}</p>
            )}
          </div>
